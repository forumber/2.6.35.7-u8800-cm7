...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 1, 245760, PLL_3,    5, 2,  61440000,  850, VDD_RAW(850) },
	{ 1, 368640, PLL_3,    5, 1,  122800000, 875, VDD_RAW(875) },
	{ 1, 480000, PLL_2,    3, 0,  122800000, 900, VDD_RAW(900), &pll2_tbl[0] },
	{ 1, 544000, PLL_2,	   3, 0,  122800000, 900, VDD_RAW(900), &pll2_tbl[1] },
    { 1, 600000, PLL_2,    3, 0,  122800000, 925, VDD_RAW(925), &pll2_tbl[2] },   
	{ 1, 768000, PLL_1,    2, 0,  153600000, 975, VDD_RAW(975) },
	{ 1, 806400,  PLL_2, 3, 0, UINT_MAX, 1000, VDD_RAW(1000), &pll2_tbl[3]},
	{ 1, 1024000, PLL_2, 3, 0, UINT_MAX, 1100, VDD_RAW(1100), &pll2_tbl[4]},
	{ 1, 1200000, PLL_2, 3, 0, UINT_MAX, 1200, VDD_RAW(1200), &pll2_tbl[5]},
	{ 1, 1401600, PLL_2, 3, 0, UINT_MAX, 1300, VDD_RAW(1300), &pll2_tbl[6]},
	{ 1, 1516800, PLL_2, 3, 0, UINT_MAX, 1325, VDD_RAW(1325), &pll2_tbl[7]},
